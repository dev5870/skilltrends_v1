...
<div class="site-index">
    ...
    <div class="jumbotron">
        <h2>Профессия: SEO оптимизатор</h2>

        <?php
        $input = Input::getDataByProfessionalArea('site_optimization_seo');
        ...
        <?php
        $query = array();
        $area = array('site_optimization_seo');
        ...
        echo Highcharts::widget([
            'options' => [
                'title' => ['text' => 'Количество вакансий: SEO оптимизатор'],
                'xAxis' => [
